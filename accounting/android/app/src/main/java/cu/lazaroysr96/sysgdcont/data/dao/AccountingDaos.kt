...
interface IngresoGastoCuentaDao {
    @Query("SELECT * FROM ingreso_gasto_cuenta")
    fun observeAll(): Flow<List<IngresoGastoCuenta>>

    @Query("SELECT * FROM ingreso_gasto_cuenta")
    suspend fun getAll(): List<IngresoGastoCuenta>
...
interface IngresoGastoNotaDao {
    @Query("SELECT * FROM ingreso_gasto_nota")
    fun observeAll(): Flow<List<IngresoGastoNota>>

    @Query("SELECT * FROM ingreso_gasto_nota")
    suspend fun getAll(): List<IngresoGastoNota>
...
interface TributoConfigDao {
    ...
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insert(config: TributoConfig)
...
interface TributoCuentaBaseDao {
    @Query("SELECT * FROM tributo_cuenta_base")
    fun observeAll(): Flow<List<TributoCuentaBase>>

    @Query("SELECT * FROM tributo_cuenta_base")
    suspend fun getAll(): List<TributoCuentaBase>
