...
export async function GET(request: NextRequest, { params }: { params: { slug: string } }) {
  ...
  try {
    ...
    const mockComments = [
      {
        ...
        content: "¡Excelente integración! Justo lo que necesitábamos para nuestro equipo.",
        is_approved: true,
        ...
        replies: [
          {
            ...
            content: "Sí, estamos trabajando en la integración con GitLab. Esperamos lanzarla pronto.",
            is_approved: true,
    ...
    return NextResponse.json({ success: false, error: "Error al obtener los comentarios" }, { status: 500 })
  }
}
...
export async function POST(request: NextRequest, { params }: { params: { slug: string } }) {
  ...
  try {
    ...
    return NextResponse.json({ success: false, error: "Error al crear el comentario" }, { status: 500 })
  }
}
