...
import { AlertCircle, ChevronLeft, ChevronRight, Inbox, RefreshCw, Sparkles } from "lucide-react"
...
export default function DescubrePage() {
	...
	const paginatedPosts = safePosts.slice(startIndex, startIndex + ITEMS_PER_PAGE)
				...
				<div className="container mx-auto px-4 md:px-6">
					<div className="max-w-3xl mx-auto text-center mb-16">
						...
						<p className="text-lg md:text-xl text-muted-foreground text-pretty leading-relaxed">
							Explora lo que nuestra comunidad tiene para ti. Productos, servicios y
							oportunidades publicadas por usuarios de SYSGD.
						</p>
					</div>
		...
		<div className="flex flex-col justify-center items-center min-h-[500px] gap-6 max-w-md mx-auto text-center px-4">
			...
			<div className="space-y-3">
				...
				<p className="text-gray-600 dark:text-gray-400 leading-relaxed">
					No pudimos cargar las publicaciones en este momento. Por favor, verifica tu
	...
	return (
		<div className="flex flex-col justify-center items-center min-h-[500px] gap-6 max-w-md mx-auto text-center px-4">
			...
			<div className="space-y-3">
				...
				<p className="text-gray-600 dark:text-gray-400 leading-relaxed">
					Sé el primero en compartir lo que tienes. Los usuarios Pro y VIP pueden publicar
					productos y servicios en Descubre.
				</p>
			</div>
...
function PostsList({ posts, totalPages, currentPage, onPageChange, totalItems }: PostsListProps) {
