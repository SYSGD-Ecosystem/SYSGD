import {  Box, CircleDollarSignIcon, FileText, Search, LayoutDashboard } from "lucide-react";
...
const AccountingSidebar: FC<SidebarProps> = ({
	activeSection,
	onSectionChange,
	isMobileOpen,
	onMobileClose,
	...
	const AccountingItems = [
		...
		{ id: "gc_tcp", label: "GC TCP", icon: LayoutDashboard },
	];
