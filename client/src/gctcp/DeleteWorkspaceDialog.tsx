...
export const DeleteWorkspaceDialog: FC<{
	workspace: CloudWorkspaceEntry | null;
	open: boolean;
	deleting: boolean;
	onOpenChange: (open: boolean) => void;
	onConfirm: () => void;
}> = ({ workspace, open, deleting, onOpenChange, onConfirm }) => {
			...
			<AlertDialogContent>
				<AlertDialogHeader>
					<div className="flex items-center gap-3">
						...
						<div>
							...
							<AlertDialogDescription>
								Esta accion elimina el espacio y todos sus datos dentro del ledger sincronizado.
							</AlertDialogDescription>
						</div>
					</div>
				</AlertDialogHeader>
				...
				<div className="space-y-3">
					<div className="rounded-md border border-red-200 bg-red-50 p-3 text-sm text-red-800 dark:border-red-900 dark:bg-red-950/30 dark:text-red-300">
						No se puede deshacer desde la web. Descarga un respaldo antes si necesitas conservar una copia.
					</div>
