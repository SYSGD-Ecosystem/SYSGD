...
export default function LandingPage() {
	...
	const features = [
		...
		},
		{
			...
			description:
				"Administra proyectos completos con tableros Kanban, seguimiento de tareas y colaboración en tiempo real.",
			module: "SYSGD-PROJECTS",
		},
		{
			icon: Database,
		...
		{
			icon: Clock,
			title: "Medición de Tiempo",
			description:
				"Rastrea el tiempo dedicado a tareas y proyectos con herramientas avanzadas de seguimiento temporal.",
			module: "SYSGD-PROJECTS",
		},
		{
			icon: Shield,
	...
	const modules = [
		{
			name: "SYSGD-DOCS",
			title: "Gestión Documental",
			description: "Sistema completo para organización y archivo de documentos",
			features: [
		...
		},
		{
			name: "SYSGD-PROJECTS",
			title: "Gestión de Proyectos",
			description: "Herramientas completas para administración de proyectos",
			features: [
				"Tableros Kanban",
		...
		{
			name: "SYSGD-ANALYTICS",
			title: "Analytics y Reportes",
			description: "Inteligencia de negocio y análisis de datos",
			features: [
	...
	const benefits = [
		...
		"Aumenta la productividad del equipo en un 65%",
			...
			<section className="py-20 px-4 sm:px-6 h-screen flex flex-col items-center justify-center lg:px-8">
				<div className="max-w-7xl mx-auto text-center">
					...
					<h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
						...
						<br />
						<span className="text-primary">Documental y Proyectos</span>
					</h1>
					<p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
						Transforma la manera en que tu organización maneja documentos y
						proyectos. SYSGD te ofrece una solución completa con módulos
						especializados para organizar, gestionar y optimizar todos tus
					...
					<p className="text-sm text-muted-foreground mt-4">
						✨ Incluye SYSGD-DOCS y SYSGD-PROJECTS • Configuración en 5 minutos
					</p>
				</div>
			</section>
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
							SYSGD está compuesto por módulos especializados que trabajan en
							conjunto para ofrecer una solución integral
						</p>
					</div>
				...
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
							...
							para revolucionar tu gestión empresarial
						</p>
					</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
						<div>
							...
							<p className="text-xl text-muted-foreground mb-8">
								...
								estratégico para la transformación digital completa de tu
								organización.
							</p>
				...
				<div className="max-w-7xl mx-auto">
					<div className="grid grid-cols-1 md:grid-cols-4 gap-8">
						<div>
							...
							<p className="text-muted-foreground mb-4">
								La solución más avanzada para la gestión documental y de
