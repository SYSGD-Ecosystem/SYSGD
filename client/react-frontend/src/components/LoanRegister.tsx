...
const LoanRegister: FC<LoanRegisterProps> = ({
  ...
  const { loan } = useGetLoanRegister(archiveId);
                ...
                {rows.map((props, index) => (
                  ...
                  <tr key={index}>
                    ...
                    <Td
                      ...
                      onBlur={(e) =>
                        updateRow(index, "signatura_ao", e.currentTarget.innerText)
                      }
                    />
                    <Td
                      label={props.signatura_ac}
                      onBlur={(e) =>
                        updateRow(index, "signatura_ac", e.currentTarget.innerText)
                      }
                    />
                    <Td
...
const TableHeading: FC = () => (
  <tr className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-slate-900 dark:text-gray-400">
    ...
    <th className="p-2 border dark:border-gray-700 min-w-28">Oficina Solicitante</th>
    ...
    <th className="p-2 border dark:border-gray-700 w-full">Descripción Documento</th>
    <th className="p-2 border dark:border-gray-700 min-w-24">Fecha Devolución</th>
