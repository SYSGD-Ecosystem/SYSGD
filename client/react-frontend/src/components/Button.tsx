...
const Button: FC<ButtonProps> = ({
	...
	return (
		<button
			disabled={isDisabled}
			className={`text-sm font-light uppercase py-1.5 rounded text-white disabled:opacity-65 disabled:cursor-not-allowed transition duration-500 w-full max-w-28 ${
				variant === 0
