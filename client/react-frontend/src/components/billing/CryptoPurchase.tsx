...
const CryptoPurchase: React.FC = () => {
  ...
  const [purchaseStep, setPurchaseStep] = useState<'select' | 'approve' | 'pay' | 'complete'>('select');
...
const paymentGatewayAddress = "0x484cad0b7237dfda563f976ce54a53af1b515a5c";
  ...
  const creditProducts = products.filter(p => p.productId.startsWith('credits_'));
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="text-xl">
              ...
              {isPlan && (
                <>
                  {tier === 'pro' ? <Zap className="inline h-5 w-5 mr-1" /> : <Star className="inline h-5 w-5 mr-1 fill-current" />}
                  {tier.toUpperCase()}
                </>
              )}
            </CardTitle>
            ...
            {isPlan && (
              <>
                ...
                <div className="flex items-center gap-2 text-sm">
                  <Check className="h-4 w-4 text-green-500" />
                  <span>
                    {tier === 'pro' ? '100' : '500'} créditos AI/{period === 'monthly' ? 'mes' : 'año'}
                  </span>
                </div>
                {tier === 'vip' && (
                  <div className="flex items-center gap-2 text-sm">
    ...
    <div className="container max-w-7xl mx-auto p-6 space-y-6">
      ...
      {networkInfo && (
        <Alert>
          ...
          <AlertDescription>
            Conectado a <strong>{networkInfo.name}</strong> (ChainID: {networkInfo.chainId})
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span>Paso {purchaseStep === 'approve' ? '1' : purchaseStep === 'pay' ? '2' : '3'} de 3</span>
            ...
            <div className="bg-muted p-4 rounded-lg space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-bold text-lg">${selectedProduct.price} USDT</span>
              </div>
              <div className="flex justify-between">
            ...
            {purchaseStep === 'approve' && (
              <div className="space-y-4">
                <Alert>
                  <AlertCircle className="h-4 w-4" />
                  <AlertDescription>
                    Primero debes aprobar que el contrato pueda usar tus USDT. Esta es una transacción segura estándar de Ethereum.
                  </AlertDescription>
                </Alert>
                <Button 
              ...
              <div className="space-y-4 text-center">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Tu compra ha sido procesada correctamente. Los créditos se agregarán a tu cuenta en unos momentos.
                  </p>
                </div>
                {txHash && (
                  <div className="bg-muted p-3 rounded-lg">
                    <div className="text-xs text-muted-foreground mb-1">Hash de transacción:</div>
