	...
	return (
		<div className="flex flex-col items-center">
			...
			<div className="relative">
				...
				{hasChildren && (
					<div className="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-8 bg-border top-full" />
				)}
			</div>
			...
			{hasChildren && (
				<div className="relative mt-8">
					...
					{employee.children!.length > 1 && (
						<div className="absolute top-0 left-0 right-0 h-0.5 bg-border transform -translate-y-4" />
					)}
					...
					<div className="flex justify-center space-x-8 lg:space-x-12">
						...
						{employee.children!.map((child, _index) => (
							<div key={child.id} className="relative">
								{/* biome-ignore lint/style/noNonNullAssertion: <explanation> */}
								{employee.children!.length > 1 && (
									<div className="absolute left-1/2 transform -translate-x-1/2 w-0.5 h-4 bg-border -top-4" />
								)}
