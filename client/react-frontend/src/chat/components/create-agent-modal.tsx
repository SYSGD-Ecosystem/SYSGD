...
import { Agent, CreateAgentRequest, AgentSupport } from "../../types/Agent";
...
export const CreateAgentModal: FC<CreateAgentModalProps> = ({
  ...
  const supportOptions: { value: AgentSupport; label: string; description: string }[] = [
    { value: "text", label: "Texto", description: "Procesa mensajes de texto" },
    { value: "image", label: "Imágenes", description: "Procesa imágenes" },
    { value: "audio", label: "Audio", description: "Procesa archivos de audio" },
    { value: "video", label: "Video", description: "Procesa archivos de video" },
  ];
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Configura un nuevo agente de IA que se integrará con el sistema de chat.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              La URL debe ser un endpoint que acepte peticiones POST con el formato estándar.
            </p>
          </div>
