    ...
    if (taskConfig?.states) {
      ...
      if (stateConfig) {
        ...
        switch (stateConfig.name.toLowerCase()) {
          case "completada":
          case "completado":
            return <CheckCircle className="w-4 h-4" style={{ color: iconColor }} />;
          case "en progreso":
          case "en progreso":
            return <Clock className="w-4 h-4" style={{ color: iconColor }} />;
          case "pendiente":
            return <AlertCircle className="w-4 h-4" style={{ color: iconColor }} />;
          default:
            return <div className="w-4 h-4 rounded-full" style={{ backgroundColor: iconColor }} />;
        }
      }
    }
