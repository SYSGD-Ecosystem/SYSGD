				...
				<div className="space-y-6">
					...
					<Card className="border-2 border-blue-500">
						...
						<CardContent className="pt-6">
							<div className="space-y-4">
								<div>
									<h4 className="font-semibold text-gray-900 mb-2">4.1 Método de Pago</h4>
									<p className="text-gray-700 leading-relaxed">
								...
								<div>
									<h4 className="font-semibold text-gray-900 mb-2">4.3 Créditos y Planes</h4>
									<ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
								...
								<div>
									<h4 className="font-semibold text-gray-900 mb-2">4.4 Errores en Transacciones</h4>
									<p className="text-gray-700 leading-relaxed">
								...
								<div>
									<h4 className="font-semibold text-gray-900 mb-2">4.5 Wallets y Seguridad</h4>
									<ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
					...
					<Card className="border-2 border-purple-500">
						...
						<CardContent className="pt-6">
							<div className="space-y-4">
								<div>
									<h4 className="font-semibold text-gray-900 mb-2">5.1 Consumo de Créditos</h4>
									<p className="text-gray-700 leading-relaxed">
								...
								<div className="bg-yellow-50 border border-yellow-300 rounded-lg p-4">
									<h4 className="font-semibold text-yellow-900 mb-2">5.2 Calidad y Precisión del Contenido</h4>
									<p className="text-yellow-800 leading-relaxed">
										<strong>NO garantizamos</strong> la precisión, calidad o idoneidad del contenido 
										generado por IA. Los modelos pueden:
									</p>
									<ul className="list-disc list-inside space-y-1 text-yellow-800 ml-4 mt-2">
								...
								<div>
									<h4 className="font-semibold text-gray-900 mb-2">5.3 Uso Responsable</h4>
									<ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
										...
										<li>Respetar los términos de uso de los modelos de IA subyacentes</li>
									</ul>
								</div>

								<div>
									<h4 className="font-semibold text-gray-900 mb-2">5.4 Propiedad del Contenido</h4>
									<p className="text-gray-700 leading-relaxed">
					...
					<Card>
						...
						<CardContent>
							<ul className="list-disc list-inside space-y-2 text-gray-700">
								...
								<li>El servicio puede sufrir interrupciones sin previo aviso debido a mantenimiento o errores</li>
					...
					<Card>
						...
						<CardContent>
							<div className="space-y-3">
								<div>
									<h4 className="font-semibold text-gray-900 mb-2">10.1 Por el Usuario</h4>
								...
								<div>
									<h4 className="font-semibold text-gray-900 mb-2">10.2 Por SYSGD</h4>
									<p className="text-gray-700">
								...
								<div>
									<h4 className="font-semibold text-gray-900 mb-2">10.3 Fin de la Fase Beta</h4>
									<p className="text-gray-700">
						...
						<div className="space-y-3">
							...
							<div className="grid md:grid-cols-2 gap-3">
								<div className="bg-white rounded-lg p-3 border border-blue-200">
									<p className="text-sm text-gray-700">✓ Has leído y comprendido estos términos</p>
								</div>
								<div className="bg-white rounded-lg p-3 border border-blue-200">
									<p className="text-sm text-gray-700">✓ Aceptas todos los riesgos de la fase beta</p>
								</div>
								<div className="bg-white rounded-lg p-3 border border-blue-200">
									<p className="text-sm text-gray-700">✓ Comprendes que las transacciones cripto son irreversibles</p>
								</div>
								<div className="bg-white rounded-lg p-3 border border-blue-200">
									<p className="text-sm text-gray-700">✓ Verificarás el contenido generado por IA</p>
								</div>
							</div>
							<p className="text-blue-700 font-medium text-center mt-4">
