  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 p-4">
      <div className="max-w-7xl mx-auto">
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <CardTitle className="text-2xl font-bold">Organigrama Empresarial</CardTitle>
        ...
        {/* Organigrama */}
        <Card className={`shadow-lg ${isFullscreen ? "fixed inset-4 z-50" : ""}`}>
          <CardContent className={`${isFullscreen ? "h-full overflow-auto" : "p-8"}`}>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
              {[
                ...
                { name: "Tecnología", color: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300" },
                { name: "Desarrollo", color: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300" },
                { name: "Infraestructura", color: "bg-cyan-100 text-cyan-800 dark:bg-cyan-900/30 dark:text-cyan-300" },
                { name: "Finanzas", color: "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300" },
                {
                  name: "Contabilidad",
                  color: "bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300",
                },
                { name: "Ventas", color: "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300" },
              ].map((dept) => (
                <Badge key={dept.name} className={`${dept.color} justify-center`}>
                  {dept.name}
                </Badge>
              ))}
            </div>
