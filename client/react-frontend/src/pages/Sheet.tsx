...
const EditableSpreadsheet = () => {
	...
	return (
		<div className="w-full min-h-screen h-full flex flex-col bg-gray-50">
			...
			<div className="bg-white border-b border-gray-200 p-3 flex items-center gap-2 flex-wrap shadow-sm">
				...
				<div className="flex items-center gap-1 border-r border-gray-200 pr-3">
					...
					<Button
						...
						size="sm"
						variant="outline"
						disabled={!copiedCell || !selectedCell}
					>
									...
									<tr key={rowKey}>
										...
										{tableData[rowKey].map((cell, cellIndex) => (
											...
											<td
												...
												onClick={() =>
													handleCellClick(cell.id, rowKey, cellIndex)
												}
											...
											>
												{editingCell === cell.id ? (
													<Input
														...
														onKeyDown={(e) =>
															handleCellKeyDown(e, rowKey, cellIndex)
														}
													...
													<div className="w-full h-full p-1 text-sm flex items-center min-h-[32px]">
														{cell.value ||
															(isEditing && selectedCell === cell.id
			...
			<div className="bg-white border-t border-gray-200 p-2 text-sm text-gray-600 flex items-center justify-between">
				...
				<div className="flex items-center gap-4">
					<div className="text-xs text-gray-500">
						Usa las flechas ↑↓←→ para navegar • Enter para editar • Tab para
						siguiente celda
					</div>
					<div className="flex items-center gap-2">
						<span
							className={cn(
								...
								isEditing ? "bg-green-500" : "bg-gray-400",
							)}
						/>
